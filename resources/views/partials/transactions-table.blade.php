...
<tr class="bg-white dark:bg-gray-900">
    ...
    <td class="px-6 py-1 whitespace-nowrap border border-gray-700 text-gray-300">{{ number_format($transaction->amount, 2) }}</td>
    <td class="px-5 py-1 whitespace-nowrap border border-gray-700 text-gray-300">
